...
API_ID = int(environ.get('API_ID', '20568792'))
API_HASH = environ.get('API_HASH', '27958cea71c6638d82cd3ceb74674aa2')
BOT_TOKEN = environ.get('BOT_TOKEN', "1954998045:6400259910:AAFqwyH7mKktO30sGV8qwPptBlDWkft8MRw")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1954998045').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002009445789').split()] #Channel id for auto indexing ( make sure bot is admin )
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rename:rename@cluster0.g0r1oei.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001938308830')) #Log channel id ( make sure bot is admin )
